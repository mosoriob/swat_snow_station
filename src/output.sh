...
if [ ! -f TxtInOut/output.rsv ]; then
    ...
    mv TxtInOut/output.rsv ${OUTPUTS3}
fi
if [ ! -f TxtInOut/output.sed ]; then
    ...
    mv TxtInOut/output.sed ${OUTPUTS4}
fi
if [ ! -f TxtInOut/watout.dat ]; then
    ...
    mv TxtInOut/watout.dat ${OUTPUTS5}
fi
if [ ! -f TxtInOut/septic.out ]; then
    ...
    mv TxtInOut/septic.out ${OUTPUTS6}
fi
if [ ! -f TxtInOut/bmp-ri.out ]; then
    ...
    mv TxtInOut/bmp-ri.out ${OUTPUTS7}
fi
if [ ! -f TxtInOut/bmp-sedfil.out ]; then
    ...
    mv TxtInOut/bmp-sedfil.out ${OUTPUTS8}
fi
if [ ! -f TxtInOut/output.hru ]; then
    ...
    mv TxtInOut/output.hru ${OUTPUTS9}
fi
if [ ! -f TxtInOut/input.std ]; then
    ...
    mv TxtInOut/input.std ${OUTPUTS10}
fi
...
if [ ! -f TxtInOut/output.rch ]; then
    ...
    mv TxtInOut/output.rch ${OUTPUTS12}
fi
if [ ! -f TxtInOut/output.std ]; then
    ...
    mv TxtInOut/output.std ${OUTPUTS13}
fi
if [ ! -f TxtInOut/output.sub ]; then
    ...
    mv TxtInOut/output.sub ${OUTPUTS14}
fi
